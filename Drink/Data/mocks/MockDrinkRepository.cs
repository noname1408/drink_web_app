...
namespace Drink.Data.mocks
{
    public class MockDrinkRepository:IDrinkRepository
    {
        ...
        public IEnumerable<Models.Drink> PreferredDrinks { get; }
        public Models.Drink GetDrinkById(int drinkId)
        {
